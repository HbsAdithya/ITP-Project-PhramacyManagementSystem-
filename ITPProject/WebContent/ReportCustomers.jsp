			...
			<!--Nav bar-->
				<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
					  ...
					  <!--Nav bar end-->
							...
							<div class="addform" >
									<form class="form-horizontal"  action="ReportCustomer.jsp">
										...
										<div class="form-group">
												<button type="submit" class="btn btn-primary"><a href="ReportCustomer.jsp" style="color: white;">Download</a></button>
										</div>
